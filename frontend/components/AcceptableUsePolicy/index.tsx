...
export const AcceptableUsePolicy = () => {
  return (
    <div className={styles.acceptableUsePolicyWrapper}>
      ...
      <p>
        ...
        content available on the Services ("Content") and
      </p>
      <p>
      ...
      <p>
        ...
        views and ideas on a number of topics. However, despite our best efforts
      ...
      <p>
        Please assess the content you submit and/or vote on with the following
        guidelines to determine if it helps creating a better information
        environment:
      </p>
      <ul>
        <li>
          It meets baseline journalistic quality standards (fact-checked,
          balanced, verified, fair, ...)
        </li>
        <li>It fosters mutual understanding</li>
        <li>It broadens the horizon</li>
        <li>It expands knowledge</li>
      ...
      <p>
        ...
        this Policy; however, we will determine, in our sole discretion, whether
      ...
      <ul>
        ...
        <li>
          you do not and will not organize a campaign encouraging others to post
      ...
      <p>
        ...
        proceedings against you when we believe that there is a genuine risk to
      ...
      <p>
        ...
        removed or blocked from the Services, please refer to the contact
        details at the bottom of this document and we will promptly review our
        decision to remove such Content or Contribution. The Content or
        Contribution may stay "down" whilst we conduct the review process.
      </p>
      <p>
        Guideline violations will result in posting access being restricted by
        first being flagged for moderation. This will require a moderator to
        approve a user's post. This restriction is meant to be temporary, and
        will be lifted when the moderators see the situation has been resolved.
        If a user cannot follow the guidelines after that, their account will be
        blocked from posting. Further actions (such as restricting access to the
        Services as a whole) can and will be applied if necessary.
      </p>
      <h2>DISCLAIMER</h2>
      <p>
